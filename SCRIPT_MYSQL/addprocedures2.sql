...
BEGIN
	...
	UPDATE Sezione SET nome = nuovo_nome WHERE nome = vecchio_nome;
	UPDATE Appartenenza SET sezione = nuovo_nome WHERE sezione = vecchio_nome;
...
BEGIN
	...
	UPDATE Struttura SET codice = nuovo_codice WHERE codice = vecchio_codice;
	UPDATE TelefonoStruttura SET codiceStruttura = nuovo_codice WHERE codiceStruttura = vecchio_codice;
...
BEGIN
	...
	UPDATE Struttura SET codice = nuovo_codice WHERE codice = vecchio_codice;
	UPDATE TelefonoStruttura SET codiceStruttura = nuovo_codice WHERE codiceStruttura = vecchio_codice;
	UPDATE Museo_Ente SET codice = nuovo_codice WHERE codice = vecchio_codice;
...
BEGIN
	...
	UPDATE Struttura SET codice = nuovo_codice WHERE codice = vecchio_codice;
	UPDATE TelefonoStruttura SET codiceStruttura = nuovo_codice WHERE codiceStruttura = vecchio_codice;
	UPDATE CentroRestauro SET codice = nuovo_codice WHERE codice = vecchio_codice;
...
CREATE PROCEDURE inserisci_artista(
				codice CHAR(16), nome VARCHAR(64), cognome VARCHAR(64), dataNascita DATE,
				luogoNascita VARCHAR(16), vita VARCHAR(2048), stile VARCHAR(2048))
BEGIN
	...
	INSERT INTO ArtistaGenerali(codice, nome, cognome, dataNascita) VALUES (codice, nome, cognome, dataNascita);
	INSERT INTO ArtistaParticolari(codice, luogoNascita, vita, stile) VALUES (codice, luogoNascita, vita, stile);
